...
card7 = Card.Card(Sprite.Sprite(pygame.image.load('images/MilitaSquad.png')), None)
...
card8 = Card.Card(Sprite.Sprite(pygame.image.load('images/FootmenSquad.png')), None)
...
card9 = Card.Card(Sprite.Sprite(pygame.image.load('images/KnightsSquad.png')), None)
card9.addCardEffect(card_effect11)
card9.addCardEffect(card_effect12)

wooden_cards = [card1, card2, card7]
